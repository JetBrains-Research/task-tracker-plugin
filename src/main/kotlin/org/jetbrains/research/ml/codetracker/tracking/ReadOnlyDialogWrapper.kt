...
//        todo: get from server
        ...
        return "<html>Для начала решения задачи <b>${task.infoTranslation[currentLanguage]?.name}</b><br>" +
                "выберите эту задачу на панели codetracker и нажмите " +
                "<b>${PluginServer.paneText?.taskChoosePane?.get(currentLanguage)?.startSolving}</b>"
    }
